import { Calendar03Icon, CircleArrowDown01Icon, CircleArrowUp01Icon, DashboardSquare02Icon, Logout03Icon, Notification02Icon, UserMultiple02Icon } from 'hugeicons-react';
            ...
            {user &&
                <div className="user-menu">
                    <div onClick={() => setHidden(!hidden)}>
                        <h4>{user.name}</h4>
                        <p>{user.email[0] + '****@' + user.email.split('@')[1]}</p>
                        <button>
                            {!hidden ?
